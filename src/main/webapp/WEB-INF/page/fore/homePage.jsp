...
<head>
    ...
    <title>migoo.com米果-理想生活上米果</title>
</head>
<body>
<nav>
        ...
        <div class="mallSearch">
            <form action="${pageContext.request.contextPath}/product" method="get">
                <div class="mallSearch-input">
                    <input class="header_search_input" type="text" name="product_name" placeholder="搜索 米果 商品/品牌/店铺"
                           maxlength="50">
    ...
    <div class="home_nav">
        ...
        <a href="https://3c.tmall.com/" target="_blank">电器</a>
        <a href="https://miao.tmall.com/" target="_blank">鲜生</a>
        <a href="http://yao.tmall.com/" target="_blank">医药</a>
        <a href="http://wt.tmall.com/" target="_blank">营业厅</a>
        <a href="https://meilihui.tmall.com/" target="_blank">魅力惠</a>
        <a href="https://www.alitrip.com/" target="_blank">旅行</a>
        <a href="https://suning.tmall.com/" target="_blank">易购</a>
    </div>
</nav>
<div class="banner">
